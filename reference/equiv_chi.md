...
Function that performs a chi-square equivalence test for structural
equation models.
...
- popRMSEA:
  ...
  The value of the root-mean square error of approximation (RMSEA) to
  set for the equivalence bounds, which is set to .08 by default.

## Value

p-value indicating whether to reject the null hypothesis that the model
is a poor fit to the data.

## Details

Created by Counsell et al. (2020): Counsell, A., Cribbie, R. A., &
Flora, D. B. (2020). Evaluating equivalence testing methods for
measurement invariance. Multivariate Behavioral Research, 55(2),
